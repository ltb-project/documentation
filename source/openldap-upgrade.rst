...
Migration from OpenLDAP v2.4 to v2.5
====================================
...
Migration from OpenLDAP v2.5 to v2.6
====================================
...
Add the following line in ``dn: olcDatabase`` for ``frontend``, ``config``, ``mdb`` and any others present
